...
export default function App() {
  ...
  const setResult = () => {
    ...
    const meters = feet * factor;
    setMessage(`${feet} pies son ${meters.toFixed(2)} metros`);
  };

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Actividad 14</Text>
      ...
      <Text style={{ fontStyle: "italic" }}>
        ...
        <Text>
          &nbsp;Cree un programa que permita convertir X pies a M metros. P = 0.3048
        </Text>
      </Text>
