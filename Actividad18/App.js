...
export default function App() {
  ...
  const setResult = () => {
    const celsius = parseFloat(text1);
    ...
    setMessage(`${celsius} °C son ${fahrenheit.toFixed(2)} °F.`);
  };

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Actividad 18</Text>
      ...
      <Text style={{ fontStyle: "italic" }}>
        ...
        <Text>
          &nbsp;Cree un programa que permita convertir grados centígrados a grados Fahrenheit. (°C × 9/5) + 32 = °F
        </Text>
      </Text>
      ...
      <View style={styles.inputContainer}>
        <TextInput
          style={styles.input}
          placeholder="Ingresa los grados °C"
