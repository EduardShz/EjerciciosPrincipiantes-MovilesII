...
export default function App() {
  ...
  const setResult = () => {
    const gallons = parseFloat(text1);
    ...
    const liters = gallons * factor;
    setMessage(`${gallons} galones son ${liters.toFixed(2)} litros.`);
  };

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Actividad 17</Text>
      ...
      <Text style={{ fontStyle: "italic" }}>
        ...
        <Text>
          &nbsp;Cree un programa que permita convertir G galones a L litros. 1 galón = 3.78541 litros
        </Text>
      </Text>
      ...
      <View style={styles.inputContainer}>
        <TextInput
          style={styles.input}
          placeholder="Ingresa la cantidad de galones"
